defmodule GetDepsBoom.MixProject do
  use Mix.Project
  ...
  # invoke GetDepsBoom.start/2 when running on a target.
  def application("host") do
    [extra_applications: [:logger]]
  end

  def application(_target) do
    [mod: {GetDepsBoom.Application, []}, extra_applications: [:logger]]
  end

  # Run "mix help deps" to learn about dependencies.
  defp deps do
    [
      {:spiffy_web_app, github: "michaelkschmidt/spiffy_web_app"},
      {:nerves, "~> 0.7", runtime: false},
      {:sqlite, github: "mmzeeman/esqlite" },
